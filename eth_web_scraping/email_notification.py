...
if __name__ == "__main()__":
    email_notification_obj = EmailNotification(contact_file="eth_web_scraping/files/contacts.txt",
                                               template_message_file="eth_web_scraping/files/message_template.txt")
